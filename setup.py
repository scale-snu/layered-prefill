...
ops_extension = CUDAExtension(
    ...
    sources=[
        ...
        "csrc/moe/kernel_bf16_kfe2m1f.cu",
        "csrc/moe/kernel_bf16_kfe4m3fn.cu",
        "csrc/moe/kernel_bf16_ku4.cu",
        "csrc/moe/kernel_bf16_ku4b8.cu",
        "csrc/moe/kernel_bf16_ku8b128.cu",
        "csrc/moe/kernel_fp16_kfe2m1f.cu",
        "csrc/moe/kernel_fp16_kfe4m3fn.cu",
        "csrc/moe/kernel_fp16_ku4.cu",
        "csrc/moe/kernel_fp16_ku4b8.cu",
        "csrc/moe/kernel_fp16_ku8b128.cu",
        "csrc/moe/gptq_marlin_repack.cu",
        "csrc/moe/ops.cu",
    ],
    extra_compile_args={
        "cxx": CXX_FLAGS,
