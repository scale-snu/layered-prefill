...
class Sequence:
    ...
    def __getstate__(self):
        ...
        """
        return (self.status, self.stage, self.num_stages, self.seq_id, self.num_tokens, self.num_prompt_tokens, self.num_processed_tokens, self.num_tokens_to_process, self.block_table,
    ...
    def __setstate__(self, state):
        ...
        직렬화된 상태에서 시퀀스 복원
        """
        self.status, self.stage, self.num_stages, self.seq_id, self.num_tokens, self.num_prompt_tokens, self.num_processed_tokens, self.num_tokens_to_process, self.block_table = state[:-1]
